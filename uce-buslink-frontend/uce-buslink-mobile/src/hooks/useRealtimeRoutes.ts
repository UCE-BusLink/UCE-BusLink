...
// Keeps the ['routes'] cache (read by RoutesScreen, AdminDashboardScreen, etc.)
// in sync in real time: when an admin creates, edits, (de)activates or deletes
// a route, every connected client applies the change directly to its cache —
// no refetch, no polling.
