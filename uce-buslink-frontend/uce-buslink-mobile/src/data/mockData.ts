...
export const trips: Trip[] = [
  { id: 't1', routeId: 'norte', time: '20:30', driver: 'Carlos Ruiz', availableSeats: 5, standingSpots: 10, status: 'confirmed' },
  { id: 't2', routeId: 'norte', time: '21:00', driver: 'Ana Lopez', availableSeats: 0, standingSpots: 12, status: 'confirmed' },
  { id: 't3', routeId: 'norte', time: '21:45', driver: 'Luis Gomez', availableSeats: 0, standingSpots: 0, status: 'unavailable' },
  { id: 't4', routeId: 'sur', time: '19:30', driver: 'María Torres', availableSeats: 8, standingSpots: 5, status: 'confirmed' },
  { id: 't5', routeId: 'sur', time: '20:30', driver: 'Pedro Vega', availableSeats: 3, standingSpots: 20, status: 'confirmed' },
  { id: 't6', routeId: 'sur', time: '21:45', driver: 'Rosa Méndez', availableSeats: 0, standingSpots: 0, status: 'unavailable' },
  { id: 't7', routeId: 'valle', time: '18:30', driver: 'Jorge Salinas', availableSeats: 0, standingSpots: 5, status: 'confirmed' },
  { id: 't8', routeId: 'valle', time: '20:15', driver: 'Carla Núñez', availableSeats: 0, standingSpots: 0, status: 'unavailable' },
];
